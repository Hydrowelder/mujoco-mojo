...
def test_sample_task_execution(sm: SignalManager) -> None:
    ...
    def mock_sample(model: mujoco.MjModel, data: mujoco.MjData) -> None:
        nonlocal was_called
...
def test_multiple_samplers_execution_order(sm: SignalManager) -> None:
    ...
    def sampler_1(model: mujoco.MjModel, data: mujoco.MjData) -> None:
        execution_order.append(1)
        sm.post(1.0, "Sampler", ("One",))

    def sampler_2(model: mujoco.MjModel, data: mujoco.MjData) -> None:
        execution_order.append(2)
        sm.post(2.0, "Sampler", ("Two",))

    def sampler_3(model: mujoco.MjModel, data: mujoco.MjData) -> None:
