...
def mj_copyState(
    m: mujoco._structs.MjModel,
    src: mujoco._structs.MjData,
    dst: mujoco._structs.MjData,
...
def mj_extractState(
    m: mujoco._structs.MjModel,
    src: typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"],
    srcsig: typing.SupportsInt,
    dst: typing.Annotated[
        numpy.typing.NDArray[numpy.float64], "[m, 1]", "flags.writeable"
    ],
    dstsig: typing.SupportsInt,
) -> None:
    """
...
def mj_printFormattedScene(
    s: mujoco._structs.MjvScene, filename: str, float_format: str
) -> None:
    """
...
def mj_resetDataDebug(
    m: mujoco._structs.MjModel,
    d: mujoco._structs.MjData,
    debug_value: typing.SupportsInt,
) -> None:
    """
...
def mj_setState(
    m: mujoco._structs.MjModel,
    d: mujoco._structs.MjData,
    state: typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"],
    sig: typing.SupportsInt,
) -> None:
    """
    Set state.
...
def mjv_cameraFrustum(
    zver: typing.Annotated[
        numpy.typing.NDArray[numpy.float32], "[2, 1]", "flags.writeable"
    ],
    zhor: typing.Annotated[
        numpy.typing.NDArray[numpy.float32], "[2, 1]", "flags.writeable"
    ],
    zclip: typing.Annotated[
        numpy.typing.NDArray[numpy.float32], "[2, 1]", "flags.writeable"
    ],
    m: mujoco._structs.MjModel,
    cam: mujoco._structs.MjvCamera,
