...
class SensorFramelinvel(SensorBase):
    """This element creates a sensor that returns the 3D unit vector corresponding to the linear velocity of the spatial frame of the object, in global coordinates."""
