...
class Attach(XMLModel):
    ...
    tag = "attach"
    attributes = ("model", "body", "frame", "prefix")

    __exclusive_groups__ = (("body", "frame"),)
    ...
    frame: str | None = None
    """Name of the frame in the child model to attach here. If neither this attribute nor body is specified (only one allowed), the contents of the world body will be attached in a new frame."""
